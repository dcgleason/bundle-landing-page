                ...
                <div className="ml-4 flex lg:ml-0 relative">
                  <a href="#">
                    ...
                    <Image
                      ...
                      src='https://upload.wikimedia.org/wikipedia/commons/b/bb/No_Heart_Transparent_Dachshund.png'
                      alt=""
                      height='6'
                      width='6' />
                  </a>
              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500">Bundle book: <em>noun, thoughtful gift,</em> a book of written letters and meaningful pictures provided by the recipient&apos;s friends and family meant to encourage, inspire, and remind the recipient of their best self.</p> 
...
{/* {uncomment this, and make stripe a non-test acconut to go live } */}
      ...
      <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
        It&apos;s time to show your loved one just how much they&apos;re loved.
      </h2>{" "}
