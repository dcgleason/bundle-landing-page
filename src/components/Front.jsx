...
const product = {
  name: "The perfect give for your dad, who already has everything.", // // give love, get love. //   "Love is not just an emotion, it's an action."
  price: '$65',
  description:
   '',
  imageSrc: "test",
...
{/* {uncomment this, and make stripe a non-test acconut to go live } */}
      ...
      <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
           Show your Dad / Husband / Boyfriend how much mean to their family, friends, and you:
      </h2>{" "}
