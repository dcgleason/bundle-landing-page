      ...
      <section aria-labelledby="reviews-heading" className="bg-white">
        <div className="max-w-2xl mx-auto py-24 px-4 sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
          <div className="lg:col-span-12 flex flex-col items-center">
            <h2 className="text-3xl font-bold text-center mt-4 mb-6">Gather love and support from family & friends ...</h2>
            ...
            <h2 className="text-2xl font-bold text-center mt-8">...to create a lasting reminder of the moments that matter most.</h2>
          </div>
        </div>
      </section>
        </main>
