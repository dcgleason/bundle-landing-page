...
const product = {
  name: "Create a heartfelt keepsakes for any occasion", // // give love, get love. //   "Love is not just an emotion, it's an action."
  price: '$49',
  description:
   '',
  imageSrc: "test",
      ...
      <section aria-labelledby="reviews-heading" className="bg-white">
        <div className="max-w-2xl mx-auto py-24 px-4 sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
          <div className="lg:col-span-12 flex flex-col items-center">
            <h2 className="text-3xl font-bold text-center mt-4 mb-6">Gather love and support from friends and family...</h2>
            ...
            <h2 className="text-2xl font-bold text-center mt-8">...to celebrate love, friendship, and life with Bundl.</h2>
          </div>
        </div>
      </section>
        </main>
