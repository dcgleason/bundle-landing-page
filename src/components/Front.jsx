...
const product = {
  name: "The perfect give for the guy who already has everything.", // // give love, get love. //   "Love is not just an emotion, it's an action."
  price: '$65',
  description:
   '',
  imageSrc: "test",
              ...
              {breadcrumbIdx !== product.breadcrumbs.length - 1 ? (
                ...
                <section aria-labelledby="information-heading" className="mt-4">
                  ...
                  <div className="mt-4 space-y-6">
                    <p className="text-base text-gray-500">Bundl book: <em> noun; a thoughtful give</em> a physical book of heartfelt, prompt-driven letters and pictures from your recipient&apos;s friends and family meant to encourage, inspire, and remind the recipient of the love they have around them.  </p> 
...
{/* {uncomment this, and make stripe a non-test acconut to go live } */}
      ...
      <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
           Show him how much he means to his family, friends, and you:
      </h2>{" "}
        ...
        Give a Bundl book with our app on the following occasions:
              ...
              {/* Start of occations */}
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#8B0000]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <p className="mt-3 text-base text-gray-500">Congratulate someone on his accomplishments.</p>
                </div>
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#8B0000]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                  ...
                  <p className="mt-3 text-base text-gray-500">Give a the groom a gift he can cherish for years to come.</p>
                </div>
                <div>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-auto text-[#8B0000]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  ...
                  <p className="mt-3 text-base text-gray-500">Offer well-wishes to a co-worker on his final day.</p>
                </div>
