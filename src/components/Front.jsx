...
{/* {beta button for sign ups - will not use} */}
      ...
      <p className="ml-2 text-sm text-gray-500">In stock and ready to ship</p>
              ...
              {/* Product image */}
{/* {uncomment this, and make stripe a non-test acconut to go live } stripe={stripePromise} */}
      ...
      <section aria-labelledby="reviews-heading" className="bg-white">
        <div className="max-w-2xl mx-auto py-24 px-4 sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
          <div className="lg:col-span-12 flex flex-col items-center">
            ...
            <h2 className="text-3xl font-bold text-center mt-8">...to create a lasting reminder of the moments that matter most.</h2>
          </div>
        </div>
      </section>
        </main>
