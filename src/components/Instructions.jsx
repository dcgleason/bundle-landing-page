          ...
          <div className="lg:py-6 lg:pr-16">
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700">
                  A consierge collects email addresses of the family and friends of the person you are giving your Bundl book to from you. We will also ask that you write a brief message that will be sent out to all of your Bundl book contributors so that each person knows it is coming from you. 
                </p>
              </div>
            </div>{" "}
            <div className="flex">
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700">
                 Once the Bundl book is delivered, you will be able to give it to your recipient. Watch them love it : ) 
                </p>
              </div>
            </div>
          </div>{" "}
